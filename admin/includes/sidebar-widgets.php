		...
		<div class="wbcr-clr-subscribe-widget-body">
			...
			<form id="wbcr-factory-subscribe-widget-form" method="post">
				...
				<label class="wbcr-factory-subscribe-widget-checkbox-label">
					...
					<?php echo sprintf(__("I confirm to subscribe to the Webcraftic newsletter to receive the latest news. You can find how we use your information on our %s Privacy Policy %s", "clearfy"), '<a href="' . $terms . '" target="_blank">', '</a>'); ?>
				</label>
