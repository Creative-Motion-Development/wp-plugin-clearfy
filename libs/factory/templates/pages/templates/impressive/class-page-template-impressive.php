...
if ( ! class_exists( 'WBCR\Factory_Templates_000\Impressive' ) ) {
	/**
	 * Class Wbcr_FactoryPages000_ImpressiveThemplate
	 */
	abstract class Impressive extends \Wbcr_FactoryPages000_AdminPage {
		...
		public function assets( $scripts, $styles ) {
			...
			$this->styles->add( FACTORY_TEMPLATES_000_URL . '/pages/templates/impressive/assets/css/impressive.page.template.css' );
		}
		...
		public function flushCacheAndRulesAction() {
			...
			if ( class_exists( 'WBCR\Factory_Templates_000\Helpers' ) ) {
